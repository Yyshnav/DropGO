...
//   var isLocationUpdating = false.obs;
...
//     _debouncedGetRoute();
//     await _updateDeliveryBoyLocation(pos.latitude, pos.longitude); // Initial location update
...
//       _heading = pos.heading;
//       _debouncedGetRoute();
//       _debouncedUpdateLocation(pos.latitude, pos.longitude); // Update backend on location change
//     });
//   }
...
//   void _debouncedUpdateLocation(double latitude, double longitude) {
//     final now = DateTime.now();
//     if (_lastLocationUpdate == null || now.difference(_lastLocationUpdate!) > const Duration(seconds: 30)) {
//       _updateDeliveryBoyLocation(latitude, longitude);
//       _lastLocationUpdate = now;
//     }
//   }
  
//   Future<void> _updateDeliveryBoyLocation(double latitude, double longitude) async {
//     try {
//       final deliveryAuthApis = DeliveryAuthApis();
//       await deliveryAuthApis.updateDeliveryBoyLocation(
//         latitude: latitude,
//         longitude: longitude,
//       );
//       debugPrint("Location updated successfully: ($latitude, $longitude)");
//     } catch (e) {
//       Get.snackbar("Location Update Failed", "Error: $e");
...
class OrderLocationController extends GetxController {
  ...
  Future<void> _startLiveTracking() async {
    ...
    _debouncedGetRoute();
    await _updateDeliveryBoyLocation(pos.latitude, pos.longitude);
